...
public final class Graph {
  ...
  public List<Vertex> shortestPath(String i1, String i2) {
    ...
    final Map<Vertex, Double> distanceMap =
        vertices.stream().collect(Collectors.toMap(v -> v, v -> Double.MAX_VALUE));
  ...
  private void updateNearestNeighbors(
      final Map<Vertex, Vertex> prev,
      final PriorityQueue<Vertex> unvisited,
      final Map<Vertex, Double> distanceMap,
